 ...
 */
export const yearsMonthsDaysHoursSince = (fromDate, toDate) => pipe(({ fromDate, toDate }) => ({ delta: getDelta({ fromDate, toDate }) }), yearsSince, monthsSince, daysSince, hoursSince)({ fromDate, toDate });
